...
- The workflow follows: Write Specification → Generate Plan → Break Plan into Tasks → Implement via Claude Code → Iterate only through spec updates

## Prohibition of Manual Coding

- Manual code edits are strictly forbidden
- All code must be generated by Claude Code
- Any code not traceable to a specification is invalid
...
- Tasks must be executed in order as defined in tasks.md
