      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 to-white py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-md w-full">
          <div className="text-center mb-8">
            <div className="mx-auto bg-white rounded-full p-3 inline-block shadow-lg">
              <div className="bg-gradient-to-r from-secondary-500 to-primary-500 w-12 h-12 rounded-full flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
            </div>
            <h2 className="mt-4 text-3xl font-bold text-dark-800">Registration Successful!</h2>
            <p className="mt-2 text-dark-600">Redirecting to login page...</p>
          </div>
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 to-white py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <h2 className="mt-4 text-3xl font-bold text-dark-800">Create your account</h2>
          <p className="mt-2 text-dark-600">Get started with your todo management</p>
        </div>
        ...
        <div className="card">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <label htmlFor="confirm-password" className="block text-sm font-medium text-dark-700 mb-1">
                Confirm Password
              </label>
              <input
                id="confirm-password"
